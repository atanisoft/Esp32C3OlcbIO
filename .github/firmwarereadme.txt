If you are using JMRI to update the ESP32C3OlcbIO node you will want to use only
ESP32C3OlcbIO.bin via the JMRI Firmware Update utility.
...
esptool.py -p /dev/ttyUSB0 --before=default_reset --after=hard_reset
    ...
    0x1000 bootloader.bin 0x10000 ESP32C3OlcbIO.bin
